                ...
                <div class="row">
                    <div class="col-lg-12">
                        @if (\Session::has('success'))
                            ...
                            <br>
                        @endif
                        <form action="/dashboard/video" method="post" enctype="multipart/form-data" class="form-horizontal">
                                @csrf
                        <div class="card">
                            <div class="card-header">
                                Add <strong>Video</strong>
                            </div>
                                ...
                                @endif
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            ...
                                            <small class="form-text text-muted">Duration <strong style="color:red;">*in second</strong></small>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                        ...
                                        <div class="col-12 col-md-9">
                                            ...
                                            <small class="form-text text-muted">Embedded link of the video  |  <strong style="color:red;">/embed</strong></small>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
