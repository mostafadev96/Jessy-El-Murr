                ...
                <div class="row">
                    <div class="col-lg-12">
                        @if (\Session::has('success'))
                            ...
                            <br>
                        @endif
                            <form action="/dashboard/gallery" method="post" enctype="multipart/form-data" class="form-horizontal">
                                @csrf
                            <div class="card">
                            <div class="card-header">
                                Add <strong>Album</strong>
                            </div>
                            <div class="card-body card-block">
                                ...
                                @endif
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                            <label for="photos" class=" form-control-label">photos</label>
                                        </div>
                                        <div class="col-12 col-md-9">
