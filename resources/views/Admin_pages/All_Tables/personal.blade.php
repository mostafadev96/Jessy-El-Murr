                                ...
                                <table class="table table-borderless table-striped table-earning">
                                    ...
                                    @foreach ($personal as $person)
                                        <tr>
                                            ...
                                            <td>{{$person->info}}</td>
                                            <td>{{$person->type}}</td>
                                            <td><a href="{{'/dashboard/personal/'.$person->id.'/edit'}}" class='au-btn au-btn-icon au-btn--green au-btn--small'>Edit</a>
                                            </td>
                                            <td>
                                                <form action="{{'/dashboard/personal/'.$person->id}}" method="post">
                                                    @csrf
                                                    @method('DELETE')
