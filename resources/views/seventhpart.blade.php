        ...
        <div id="owl-carousel2" class="owl-carousel">
            <div class="item" style="opacity: 0.1; position: relative;">
                <div style="
                        ...
                        background-image: url({{asset("emma_stone_11.png")}});
                        top: -44%;
                        left: 40%;
                        position:  absolute;
                        z-index:  1;
                ...
                <div class="card" style="background:white;box-shadow:2px 7px 28px 6px rgba(0, 0, 0, 0.1);margin-top: 143px;margin-bottom:  40px;">
                    <div class="card-body" style="background:white;text-align: center;/* width: 616px; */overflow: hidden;margin-left: auto;margin-right: auto;/* padding-top: 119px; */">
                        <h1 style="display: block;font-size: 2.0rem;font-weight: bold;color: black;padding: 54px 40px 0px 50px;background:linear-gradient( 132deg, rgb(108,18,211) 0%, rgb(74,98,220) 100%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">Emma Stone</h1>
                        <p class="small-black">Jessy El Murr is a multimedia journalist, speaker and moderator with a special interest in social media and Arab youth.</p>
                    </div>
                </div>
            </div>
            <div class="item" style="opacity: 0.1; position: relative;">
